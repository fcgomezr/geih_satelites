...
class MT_job:
    ...
    def print_pop_empl(df, year):
        ...
        if year < 2021:
            ...
            print(
                ...
                "Puestos de trabajo :", round( df['Puestos'].sum()/12)
            )   
    ...
    def pivot_none(df, column_name):
        ...
        df['P7480S1A1e'] = df['fex'] * df['P7480S1A1']/12
        df['P7480S7e'] = df['fex'] * df['P7480S7A1']/12
        df['P7480S9e'] = df['fex'] * df['P7480S9A1']/12
        df['P7480S10e'] = df['fex'] * df['P7480S10A1']/12
    ...
    def calculate_NoRen_1(df):
        ...
        # Calculate the new column values.
        df['fex'] = df['fex']/12 
        fr1 = df['fex'][df['P7480S1'] == 1].groupby(df['P6020']).sum()
        fr2 = df['fex'][df['P7480S7'] == 1].groupby(df['P6020']).sum()
        fr3 = (df['fex'][df['P7480S9'] == 1].groupby(df['P6020']).sum() +
              df['fex'][df['P7480S10'] == 1].groupby(df['P6020']).sum())

        fr4 = df['P7480S1A1e'][df['P7480S1'] == 1].groupby(df['P6020']).sum()
        fr5 = df['P7480S7e'][df['P7480S7'] == 1].groupby(df['P6020']).sum()
        fr6 = (df['P7480S9e'][df['P7480S9'] == 1].groupby(df['P6020']).sum() +
              df['P7480S10e'][df['P7480S10'] == 1].groupby(df['P6020']).sum())
